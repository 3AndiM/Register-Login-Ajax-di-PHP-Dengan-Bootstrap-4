      ...
      <div class="row">
        <div class="col-md-12">
          <div class="card">
            ...
            <div class="card-body">
              <a href="tambah-siswa.php" class="btn btn-md btn-success" style="margin-bottom: 10px">Add Data</a>
              ...
              <a href="dashboard.php" class="btn btn-md btn-success" style="margin-bottom: 10px ">Back</a>
            </div>
          </div>
      </div>
    </div>
